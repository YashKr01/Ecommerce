...
/* Category items with list of product item*/
...
public class Category {
    ...
    public Category(int id, String parent_id, String category_name, String category_thumbnail,
                    String is_bigthumbnail_show, String big_thumbnail, String type, String created_at,
                    String updated_at, List<SubCategory> sub_category) {
        this.id = id;
